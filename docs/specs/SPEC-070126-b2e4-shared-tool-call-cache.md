...
supersedes: []
superseded-by:
  - maistro-engine#SPEC-062126-971d
blocks: []
blocked-by: []
contracts:
  - behavioral
...
> **Superseded by [SPEC-062126-971d](SPEC-062126-971d-shared-tool-call-cache.md).**
> This file is a stale duplicate: the date-based-ID rename (ADR-062026-9b30)
> renamed the original `SPEC-260` to `SPEC-062126-971d`, and a later, unrelated
