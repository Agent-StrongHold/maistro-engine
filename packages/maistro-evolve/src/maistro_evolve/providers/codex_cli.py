"""Use an authenticated Codex CLI as an Evolve model provider."""
...
class CodexCliProvider:
    """Async `llm_call` adapter that invokes Codex outside benchmark sandboxes.

    Each request runs in a fresh empty directory with Codex's read-only sandbox.
    The provider sends prompts over stdin and reads only the final model message.
    """
