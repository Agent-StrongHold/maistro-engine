...
- Name: app.spec.ts >> Chat Page >> shows chat empty state with suggestions
...
Locator: locator('text=Hive Conductor').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Hive Conductor').first()
