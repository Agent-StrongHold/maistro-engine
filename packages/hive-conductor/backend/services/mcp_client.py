...
def resolve_atlassian_token(user_id: str | None) -> str | None:
    ...
    try:
        ...
        # nosemgrep: python.lang.security.audit.logging.logger-credential-leak.python-logger-credential-disclosure -- logs exception text from store lookup, never the token value
