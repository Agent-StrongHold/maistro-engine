...
# Disney's Atlassian Cloud migration (~2026-06-13).
_DISNEY_CLOUD_MIGRATION = "2026-06-13"
...
def _build_catalog() -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "title": "Add your Disney Jira PAT",
            "description": (
            ...
            "context": f"On-prem path; switches to Rovo after Cloud migration ({_DISNEY_CLOUD_MIGRATION}).",
        },
        {
            "id": "cred_atlassian_server_confluence",
            "title": "Add your Disney Confluence PAT",
            "description": (
        ...
        },
        {
            ...
            "description": (
                ...
                f"before {_DISNEY_CLOUD_MIGRATION} so the fleet keeps reading "
