"""Skill Catalog — cascade with filesystem watching.

Skills are markdown documents with YAML frontmatter.
Cascade resolution: user > tenant > builtin.
...
logger = logging.getLogger("maistro.skills.catalog")
...
class SkillCatalog:
    """Skill catalog with cascade resolution and filesystem watching."""
