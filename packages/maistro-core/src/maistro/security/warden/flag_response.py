...
logger = logging.getLogger("maistro.warden.flag")

_FLAG_BANNER = (
    "\n\n"
    "---\n"
    "WARNING SECURITY NOTICE: This tool result has been flagged by Warden.\n"
    "Reason: {reason}\n"
...
def build_flagged_response(
    ...
    *,
    ...
    detection_layer: str,
    flag_id: str = "",
    admin_email: str = "security@maistro.local",
    escalation_url: str = "",
) -> str:
