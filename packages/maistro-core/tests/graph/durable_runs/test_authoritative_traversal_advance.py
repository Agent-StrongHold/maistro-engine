...
async def test_each_advancing_frontier_persists_accepted_outcome_and_commit() -> None:
    ...
    assert record.traversal_commits[1].prior_commit_id == record.traversal_commits[0].traversal_commit_id
    assert record.traversal_commits[1].prior_state_hash == record.traversal_commits[0].resulting_state_hash
