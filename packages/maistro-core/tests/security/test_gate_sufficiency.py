...
Ported from Stronghold's tests/security/test_gate_sufficiency.py. Exercises
`Gate.process_input`'s persistent/supervised/best_effort sufficiency wiring,
now backed by `maistro.security.request_analyzer.analyze_request_sufficiency`
rather than the old always-sufficient stub.
"""
