...
PRICING_UPDATE_SOURCES: dict[str, str] = {
    ...
    "writer": "https://dev.writer.com/api-guides/quickstart",
    "meta": "https://openrouter.ai/meta-llama",
    "google-gemma": "https://openrouter.ai/google",
    "qwen": "https://openrouter.ai/qwen",
    "nous-research": "https://openrouter.ai/nousresearch",
    "tng-tech": "https://openrouter.ai/tngtech",
}
...
API_QUICKSTART: dict[str, Any] = {
    ...
    "microsoft": {
        ...
        "api_base_url": "https://<resource>.openai.azure.com/openai/deployments/<deployment>/chat/completions",
        "openai_compat": True,
        "api_key_env": "AZURE_OPENAI_API_KEY",
        "python_sdk": "pip install openai  # use AzureOpenAI client with api_version param",
        ...
        "models_url": "https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/models",
        "free_trial": "Self-service startup track: $1K immediate + $4K after verification = $5K/entity",
        "notes": (
            "Phi-4 models available via Azure AI Foundry (ai.azure.com). "
            "Use AzureOpenAI(api_key=..., azure_endpoint=..., api_version='2024-10-21'). "
            "Resource URL and deployment name set during model deployment in AI Foundry."
        ),
    },
    "minimax": {
        ...
        "python_sdk": "pip install openai  # use OpenAI SDK with api_base override",
        "litellm_prefix": "openai/",
        "usage_url": "https://www.minimax.io/platform/finance/balance",
        "docs_url": "https://www.minimax.io/docs",
        "models_url": "https://openrouter.ai/minimax",
        "free_trial": "Trial credits on signup; M2.5 free tier via OpenRouter",
        "notes": "Also available via Fireworks AI (minimax-m2p1) and OpenRouter. 1M context on minimax-01.",
    },
    "writer": {
        "signup_url": "https://dev.writer.com/",
        "api_key_url": "https://app.writer.com/aistudio/organization/api-keys",
        "api_base_url": "https://api.writer.com/v1",
        "openai_compat": True,
        "api_key_env": "WRITER_API_KEY",
        "python_sdk": "pip install writer-sdk",
        "litellm_prefix": "openai/",
        "usage_url": "https://app.writer.com/aistudio/organization/billing",
        "docs_url": "https://dev.writer.com/api-guides/quickstart",
        "models_url": "https://openrouter.ai/writer",
        "free_trial": "Free tier: limited API calls on signup",
        "notes": "Palmyra X5 is enterprise-focused (1M context, $0.60/$6.00). Best for long-doc enterprise RAG.",
    },
    "meta": {
        "signup_url": "https://llama.developer.meta.com/",
        "api_key_url": "https://llama.developer.meta.com/dashboard",
        ...
        "openai_compat": True,
        "api_key_env": "LLAMA_API_KEY",
        "python_sdk": "pip install openai  # or: pip install together / fireworks-ai / groq",
        "litellm_prefix": "openai/",
        "usage_url": "https://llama.developer.meta.com/dashboard",
        "docs_url": "https://llama.developer.meta.com/docs/api",
        "models_url": "https://openrouter.ai/meta-llama",
        "free_trial": "Free tier at llama.developer.meta.com; also free via OpenRouter :free variants",
        "notes": (
            "Open weights (most models Apache 2.0 or Llama Community License). "
            "Self-host via Ollama or run via any inference provider. "
            "Official hosted API at llama.developer.meta.com — reference implementation, no quantization."
        ),
    },
    "google-gemma": {
        "signup_url": "https://openrouter.ai/",
        ...
        "models_url": "https://openrouter.ai/google",
        "free_trial": "gemma-3-4b and gemma-3-12b :free via OpenRouter; also local via Ollama (ollama pull gemma3)",
        "notes": "Open weights (Apache 2.0). Best path: OpenRouter for API, Ollama for local dev. Self-host on HuggingFace Inference Endpoints.",
    },
    "qwen": {
        "signup_url": "https://openrouter.ai/",
        "api_key_url": "https://openrouter.ai/settings/keys",
        ...
        "openai_compat": True,
        "api_key_env": "OPENROUTER_API_KEY",
        "python_sdk": "pip install openai  # or: pip install dashscope for native Alibaba API",
        "litellm_prefix": "openrouter/",
        "usage_url": "https://openrouter.ai/settings/credits",
        "docs_url": "https://help.aliyun.com/zh/dashscope/",
        "models_url": "https://openrouter.ai/qwen",
        "free_trial": "qwen-flash free on DashScope (1M tokens/day); qwen3 free variants on OpenRouter",
        "notes": (
            "Open weights (Apache 2.0 for most). Native API: DashScope (dashscope.aliyuncs.com). "
            "Also served cheaply by Fireworks, Nebius, SiliconFlow, Novita. "
            "QwQ-32B and Qwen3 235B available free via OpenRouter :free tier."
        ),
    },
    "nous-research": {
        "signup_url": "https://openrouter.ai/",
        ...
        "litellm_prefix": "openrouter/",
        "usage_url": "https://openrouter.ai/settings/credits",
        "docs_url": "https://huggingface.co/NousResearch",
        "models_url": "https://openrouter.ai/nousresearch",
        "free_trial": "hermes-3-llama-3.1-405b:free via OpenRouter",
        "notes": "Open weights on HuggingFace (Apache 2.0). Known for best-in-class function-calling fine-tunes.",
    },
    "tng-tech": {
        "signup_url": "https://openrouter.ai/",
        "api_key_url": "https://openrouter.ai/settings/keys",
        ...
        "litellm_prefix": "openrouter/",
        "usage_url": "https://openrouter.ai/settings/credits",
        "docs_url": "https://github.com/tng-tech",
        "models_url": "https://openrouter.ai/tngtech",
        "free_trial": None,
        "notes": "DeepSeek-R1T2-Chimera is a merged model (DeepSeek R1 + V3 hybrid). Available via OpenRouter only.",
    },
    "azure_openai": {
        "signup_url": "https://azure.microsoft.com/en-us/free/startups/",
        "api_key_url": "https://portal.azure.com/#view/Microsoft_Azure_ProjectOxford/CognitiveServicesHub",
        ...
        "openai_compat": True,
        "api_key_env": "AZURE_OPENAI_API_KEY",
        "python_sdk": "pip install openai  # use AzureOpenAI(azure_endpoint=..., api_version='2024-10-21')",
        "litellm_prefix": "azure/",
        "usage_url": "https://portal.azure.com/#view/Microsoft_Azure_Billing/SubscriptionsBlade",
        "docs_url": "https://learn.microsoft.com/en-us/azure/ai-services/openai/",
        "models_url": "https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/models",
        "free_trial": "Self-service startup track: $5K (no investor). Investor track: $100K+.",
        "notes": (
            "Mirrors OpenAI models but draws from Azure startup credits. "
            "FLUX.1 Kontext available via Azure AI Foundry (ai.azure.com) — key for BookCreator Book 1. "
            "GitHub Copilot can be funded from the same Azure subscription."
        ),
    },
    "baidu": {
        "signup_url": "https://qianfan.cloud.baidu.com/",
        "api_key_url": "https://console.bce.baidu.com/iam/#/iam/accesslist",
        "api_base_url": "https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat",
        "openai_compat": False,
        "api_key_env": "BAIDU_API_KEY",
        "python_sdk": "pip install qianfan",
        "litellm_prefix": "qianfan/",
        "usage_url": "https://console.bce.baidu.com/billing",
        "docs_url": "https://cloud.baidu.com/doc/WENXINWORKSHOP/",
        "models_url": "https://qianfan.cloud.baidu.com/pricing",
        "free_trial": "Free trial credits on Qianfan platform signup",
        "notes": "Not OpenAI-compatible — requires Baidu Qianfan SDK or custom auth. Mainly useful for Chinese-language production workloads.",
    },
}
