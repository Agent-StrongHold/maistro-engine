...
Uses HMAC-based comparison to prevent timing attacks. Ported from the
secret-equal.ts reference (TypeScript port source): both inputs are HMAC-SHA256 hashed
